...
def write_clinical(input_df, output_fname, debug=False):
    ...
    vax_cols = ['Research_Participant_ID', 'Cohort', 'Visit_Number', 'Vaccination_Status', 'SARS-CoV-2_Vaccine_Type', 'SARS-CoV-2_Vaccine_Lot_Number', 'SARS-CoV-2_Vaccination_Date_Duration_From_Index', 'SARS-CoV-2_Vaccination_Side_Effects', 'Other_SARS-CoV-2_Vaccination_Side_Effects', 'Comments']
