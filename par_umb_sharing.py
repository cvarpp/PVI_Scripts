...
if __name__ == '__main__':
    ...
    temail_old = report_old[report_old['participant_id'].isin(temail['Subject ID'])]
    temail_new = report_new[report_new['participant_id'].isin(temail['Subject ID'])]
    ...
    if not args.debug:
        with pd.ExcelWriter(output_filename) as writer:
            ...
            temail_old.to_excel(writer, sheet_name='TITAN Unshared Old', index=False)
            temail_new.to_excel(writer, sheet_name='TITAN Unshared New', index=False)
